...
namespace HotelProject.DataAccesLayer.Migrations
{
    ...
    [Migration("20230701045327_add_CountryAndGender")]
    partial class add_CountryAndGender
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.About", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Booking", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Contact", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Guest", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Room", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Service", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Staff", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.AppUser", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concerete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concerete.Contact", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concerete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concerete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concerete.AppUser", null)
                        .WithMany()
